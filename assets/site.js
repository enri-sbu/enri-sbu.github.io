(() => {
  document.documentElement.dataset.siteVersion = "14";
  const storage = {
  ...
  const detailCatalog = {
    about: ["معرفی پژوهشکده شبکه‌های برق", "Electrical Networks Research Institute profile", "پژوهشکده شبکه‌های برق در سال ۱۴۰۰ در دانشگاه شهید بهشتی فعالیت خود را آغاز نمود.", "The Institute began its activities in 1400 SH at Shahid Beheshti University.", "enri-building.png", "معرفی پژوهشکده", "Institute profile"],
