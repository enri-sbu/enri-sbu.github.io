(() => {
  document.documentElement.dataset.siteVersion = "15";
  const storage = {
  ...
  const ensureStickyNavLogo = () => {
    document.querySelectorAll(".main-menu .menu-row").forEach((row) => {
      if (row.querySelector(".sticky-nav-logo")) return;
      const homeHref = document.documentElement.lang === "en"
        ? (window.location.pathname.endsWith("en.html") || window.location.pathname === "/" ? "#home" : "en.html")
        : (window.location.pathname.endsWith("index.html") || window.location.pathname === "/" ? "#home" : "index.html");
      const logo = document.createElement("a");
      logo.className = "sticky-nav-logo";
      logo.href = homeHref;
      logo.setAttribute("aria-label", document.documentElement.lang === "en"
        ? "Electrical Networks Research Institute"
        : "پژوهشکده شبکه‌های برق");
      logo.innerHTML = '<img alt="" src="assets/enri-logo.png" width="819" height="456">';
      const desktopNav = row.querySelector(".desktop-nav");
      if (desktopNav) row.insertBefore(logo, desktopNav);
      else row.appendChild(logo);
    });
  };
  ...
  const detailCatalog = {
    about: ["معرفی پژوهشکده شبکه‌های برق", "Electrical Networks Research Institute profile", "پژوهشکده شبکه‌های برق در سال ۱۴۰۰ در دانشگاه شهید بهشتی فعالیت خود را آغاز نمود.", "The Institute began its activities in 1400 SH at Shahid Beheshti University.", "enri-building-hero.png", "معرفی پژوهشکده", "Institute profile"],
    ...
    "field-market": ["تجدید ساختار در صنعت برق", "Power-industry restructuring", "یکی از پنج زمینه تخصصی رسمی پژوهشکده شبکه‌های برق.", "One of the Institute’s five official specialist fields.", "photos/electricity-market.webp", "حوزه‌های تخصصی", "Research area"],
    ...
    "service-research": ["پروژه‌های تحقیقاتی صنعت برق", "Power-industry research projects", "همکاری در پروژه‌های تحقیقاتی مرتبط با نیازهای صنعت برق.", "Cooperation on research projects responding to power-industry needs.", "photos/research-lab.webp", "پژوهش مشترک", "Joint research"],
    "service-engineering": ["خدمات فنی و مهندسی", "Technical and engineering services", "ارائه خدمات فنی و مهندسی به بخش‌های مختلف صنعت برق.", "Services for different sectors of the power industry.", "photos/power-substation.webp", "خدمات تخصصی", "Specialist services"],
    "service-transfer": ["بومی‌سازی و انتقال دانش فنی", "Localization and knowledge transfer", "همکاری در انتقال و بومی‌سازی دانش فنی مورد نیاز کشور.", "Transferring and localizing technical knowledge required by the country.", "photos/specialist-training.webp", "توسعه فناوری", "Technology development"],
    "service-thesis": ["حمایت از رساله و پایان‌نامه", "Thesis and dissertation support", "جهت‌دهی به پژوهش‌های تحصیلات تکمیلی مفید برای صنعت برق.", "Directing graduate research toward useful power-industry outcomes.", "photos/research-lab.webp", "دانشگاه و صنعت", "University and industry"],
    "service-training": ["آموزش تخصصی", "Specialist education", "تربیت نیروی متخصص و برگزاری آموزش‌های تخصصی کوتاه‌مدت.", "Training skilled personnel and holding short specialist courses.", "photos/specialist-training.webp", "توسعه مهارت", "Skills development"],
    "activity-journal": ["نشریه علمی پژوهشی", "Scientific-research journal", "نشریه «تحقیقات و فناوری در صنعت برق» برای انتشار تحقیقات مؤثر در صنعت و دانشگاه‌ها.", "The journal ‘Research and Technology in the Power Industry’ publishes relevant industry and university research.", "photos/scientific-publication.webp", "انتشارات", "Publishing"],
    "activity-market": ["کارگاه‌های بازار برق", "Electricity-market workshops", "کارگاه‌های آموزشی بازار برق برای کارشناسان شرکت‌های توزیع و برق منطقه‌ای.", "Electricity-market workshops for distribution and regional-electricity specialists.", "photos/electricity-workshop.webp", "آموزش", "Education"],
    ...
    "activity-smart-cities": ["سمینار شهرهای هوشمند", "Smart-cities seminar", "سمینار بین‌المللی چالش‌های حمل‌ونقل در شهرهای هوشمند آینده ایران با همکاری دانشگاه صنعتی برلین.", "An international seminar on transportation challenges in Iran’s future smart cities with the Technical University of Berlin.", "photos/smart-city.webp", "همکاری بین‌المللی", "International collaboration"],
    "activity-companies": ["همکاری با شرکت‌ها", "Company collaboration", "همکاری‌های آموزشی، پژوهشی و خدمات مهندسی و اجرایی با شرکت‌های صنعت برق.", "Educational, research, engineering and implementation collaboration with power-industry companies.", "photos/industry-collaboration.webp", "صنعت", "Industry"],
    ...
    "project-phasor": ["مصورسازی داده‌های فازوری و تحلیل پایداری ولتاژ", "Phasor-data visualization and voltage stability", "مصورسازی داده‌های فازوری، تخمین حالت و تحلیل پایداری ولتاژ برای پایش شبکه انتقال.", "Phasor-data visualization, state estimation and voltage-stability analysis for transmission monitoring.", "photos/phasor-monitoring.webp", "پروژه صنعت برق", "Power-industry project"],
    "project-frequency-control": ["کنترل فرکانس ثانویه در بازار برق", "Secondary frequency control in the electricity market", "طراحی سازوکار مشارکت واحدهای نیروگاهی در خدمات جانبی کنترل فرکانس ثانویه.", "A participation mechanism for generating units in secondary frequency-control ancillary services.", "photos/turbine-generator.webp", "پروژه صنعت برق", "Power-industry project"],
    "project-training": ["آموزش تخصصی بخش انتقال با رویکرد مدیریت دانش", "Specialist transmission education with knowledge management", "بازنگری و تعریف دوره‌های آموزش تخصصی بخش انتقال و طرح و توسعه.", "Reviewing and defining specialist transmission and development courses.", "photos/specialist-training.webp", "پروژه آموزشی", "Education project"],
    "project-wind": ["نرم‌افزار برنامه‌ریزی تعمیرات توربین‌های بادی", "Wind-turbine maintenance-planning software", "نرم‌افزار برنامه‌ریزی تعمیرات و نگهداری توربین‌های بادی ۲٫۵ مگاواتی مپنا.", "Maintenance-planning software for MAPNA 2.5 MW wind turbines.", "photos/wind-maintenance.webp", "پروژه دیگر", "Other project"],
  ...
  if (detailPage) {
    ...
    if (id === "people" || id.startsWith("person-")) {
  ...
  const menuStickyStart = mainMenu ? mainMenu.offsetTop : 0;
  const updateScroll = () => {
    ...
    mainMenu?.classList.toggle("is-stuck", window.scrollY >= Math.max(0, menuStickyStart - 1));
  };
  updateScroll();
