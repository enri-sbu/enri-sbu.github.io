(() => {
  ...
  const progress=q('.reading-progress span'),topButton=q('.back-to-top');
  ...
  const updateScroll=()=>{
    ...
    topButton?.classList.toggle('show',scrollY>650);menu?.classList.toggle('is-stuck',scrollY>=menuStart);
  };
